...
/**
 * Created by sombramac-8 on 4/6/18.
 */
public class HostedContactForm extends TestBase {
    ...
    public void hostedContactFormTest(String configrations){
        startPage.goToSettingsSection()
                .goToContractFormPage()
                .goToHostedContactForm(configrations);
    }
}
