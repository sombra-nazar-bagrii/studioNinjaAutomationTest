...
import pageobject.leadsOverview.LeadProfilePage;

/**
 * Created by sombra-15 on 08.09.17.
 */

public class AddNewLeadModal extends Page {
    ...
    public AddNewLeadModal(WebDriver webDriver) {
        super(webDriver);
    }

    public LeadProfilePage createLead(JobConfiguration config, String leadName, String fromWhere) throws NoSuchMethodError {
        ...
        } else if(fromWhere.equals("Lead") || fromWhere.equals("DashboardPage") || fromWhere.equals("Calendar")|| fromWhere.equals("CalendarM")|| fromWhere.equals("CalendarW")){
...
//            locationNotes();
        try {
            ...
            sleepThread(5000);
            return PageFactory.initElements(webDriver, LeadProfilePage.class);
        }
